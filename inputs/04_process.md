...
- [HBK x HFK (Exkursionsliste)](https://github.com/design-hfkbremen/S26_das-grosse-kennenlernen/blob/main/hbk_hfk-exchange.md)
...
1. What questions and decisions are you currently struggeling with? Break down your project into different parameters, e.g.
   - focus
   - visual 
   - format
3. Now write all possible values of those parameters, e.g.:
   - focus: visual research | theoretical | historic | personal | documentary | speculative | participatory | ...
   - visual: photo | video | illustration | graphic | archive material | 3D | ...
   - format: print | web | poster | movie | exhibition | workshop | ...
3. Now select one value of each parameter. Try to create as many variations as possible. Max. 5mins / sketch [pen, paper, concept sentence].
...
## Wireframing [1h]
- w/ Lena und Ricardo?
- see [Tool Wireframing](https://katharinanejdl.com/hbk-basics/#:~:text=10%3A30%E2%80%9312%3A00%20%7C%20Wireframing)
- see [Personalization Wireframes](https://katharinanejdl.com/hfbk/#:~:text=10%3A30%E2%80%9311%3A00%20%7C%20Wireframing)
- see [Negotiating Type Workshop](https://github.com/design-hfkbremen/S26_negotiating-type/blob/main/negotiating-type_outcome.pdf)
